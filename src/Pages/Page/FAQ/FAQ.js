...
const FAQ = () => {
  ...
  return (
    <>
        ...
        <section>
          <div className="faq">
            <div className={change ? "question-bg" : "question"} onClick={handelClick}>
          ...
          <div className="faq">
            <div className={change3 ? "question-bg" : "question"} onClick={handelClick3}>
          ...
          <div className="faq">
            <div className={change4 ? "question-bg" : "question"} onClick={handelClick4}>
          ...
          <div className="faq">
            <div className={change5 ? "question-bg" : "question"} onClick={handelClick5}>
              <p>Do any of your cheeses contain enzymes derived from animal sources?</p>
              <div className="question-icon">
